...
use UserTagBundle\Procedure\Category\DeleteSingleUserTagCategory;
use UserTagBundle\Repository\CategoryRepository;

class DeleteSingleUserTagCategoryTest extends TestCase
{
    private DeleteSingleUserTagCategory $procedure;
    ...
    protected function setUp(): void
    {
        ...
        $this->procedure = new DeleteSingleUserTagCategory(
