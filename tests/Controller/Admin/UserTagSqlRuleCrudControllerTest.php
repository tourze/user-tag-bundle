 ...
 * @internal
 */
#[CoversClass(UserTagSqlRuleCrudController::class)]
#[RunTestsInSeparateProcesses]
final class UserTagSqlRuleCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    protected function getControllerService(): UserTagSqlRuleCrudController
    {
        return new UserTagSqlRuleCrudController();
    }
    ...
    public static function provideEditPageFields(): iterable
    {
        ...
        yield 'sqlStatement' => ['sqlStatement'];
    }
    ...
    {
        $controller = new UserTagSqlRuleCrudController();
        $this->assertInstanceOf(UserTagSqlRuleCrudController::class, $controller);
    }
