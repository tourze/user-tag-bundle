...
#[MethodTag(name: '用户标签')]
#[MethodDoc(summary: '解绑打标记录')]
#[MethodExpose(method: 'UnassignTagToBizUser')]
#[Log]
class UnassignTagToBizUser extends LockableProcedure
{
    ...
    public function execute(): array
    {
        ...
        $log = $this->userTagService->unassignTag($user, $tag);
